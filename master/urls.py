...
urlpatterns = [
    ...
    path('unit-kerja/import/', views.UnitKerjaImportView.as_view(), name='unitkerja_import'),
    path('unit-kerja/import/template/', views.template_import_unitkerja, name='unitkerja_template_import'),
    path('unit-kerja/export/<str:fmt>/', views.export_unitkerja, name='unitkerja_export'),
    ...
    path('pegawai/import/template/', views.template_import_pegawai, name='pegawai_template_import'),
    path('pegawai/export/<str:fmt>/', views.export_pegawai, name='pegawai_export'),
    ...
    path('kendaraan/import/template/', views.template_import_kendaraan, name='kendaraan_template_import'),
    path('kendaraan/export/<str:fmt>/', views.export_kendaraan, name='kendaraan_export'),
    ...
    path('rumah-dinas/import/template/', views.template_import_rumah, name='rumah_template_import'),
    path('rumah-dinas/export/<str:fmt>/', views.export_rumah, name='rumah_export'),
